...
public class GameListController {
	...
	public void moveInList(@PathVariable Long listId, @RequestBody ReplacementDTO body)
	{
		gameListService.moveInList(listId, body.getSourceIndex(), body.getDestinationIndex());
	}
}
